...
export default function Advantages() {
  return (
    <section
      id="keunggulan"
      className="bg-white px-4 py-16 sm:px-6 lg:px-8 overflow-hidden"
    >
        ...
        <StaggerContainer className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {advantages.map((item) => (
            <StaggerItem key={item.title}>
              <div className="group rounded-lg border border-slate-200 bg-white p-6 text-center transition-all duration-300 hover:-translate-y-1.5 hover:shadow-md h-full">
