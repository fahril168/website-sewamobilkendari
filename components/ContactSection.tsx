...
export default function ContactSection() {
  const whatsappNumber = "+62 823-4567-8901";
  const instagramHandle = "@sewamobilkendari_official";
  const instagramUrl = "https://instagram.com";

  return (
    <section id="kontak" className="bg-[#F8FAFC] px-4 py-16 sm:px-6 lg:px-8 border-t border-slate-200">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-12 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-12 items-stretch">
          ...
          <div className="overflow-hidden rounded-xl border border-slate-200 bg-white min-h-[350px] lg:min-h-[100%] flex flex-col shadow-sm">
            ...
            <div className="relative flex-1 w-full min-h-[320px]">
              <iframe
                ...
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d127116.74872719247!2d122.463242!3d-3.998462!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2d98b2512f45511b%3A0xa597394c8e718b53!2sKendari%2C%20Kendari%20City%2C%20Southeast%20Sulawesi!5e0!3m2!1sen!2sid!4v1700000000000!5m2!1sen!2sid"
                width="100%"
                height="100%"
                style={{ border: 0 }}
          ...
          <div className="flex flex-col justify-between rounded-xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm">
            <div>
              ...
              <div className="mt-6 space-y-5 text-sm text-slate-600">
                ...
                <div className="flex items-start gap-3.5">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-slate-500">Senin - Minggu: 24 Jam Nonstop</p>
                  </div>
                </div>
